...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250217195714_SepareatedAdressTableUsedInManyTables")]
    partial class SepareatedAdressTableUsedInManyTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Shared.Adress", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.UserDependent.CachedFilteredLocation", b =>
                {
                    b.Property<int>("CachedLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CachedLocationID"));

                    b.Property<int>("CachedAdressID")
                        .HasColumnType("int");

                    b.HasKey("CachedLocationID");

                    b.HasIndex("CachedAdressID");

                    b.ToTable("AdvertFilterLocationCached");
                });
            ...
            modelBuilder.Entity("Core.Entities.Advert", b =>
                {
                    b.HasOne("Core.Entities.Shared.Adress", "AdvertAdress")
                        .WithMany("Adverts")
                        .HasForeignKey("AdvertAdressID")
            ...
            modelBuilder.Entity("Core.Entities.Shared.Company.Company", b =>
                {
                    b.HasOne("Core.Entities.Shared.Adress", "CompanyAdress")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Shared.Adress", "UserAdress")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Core.Entities.UserDependent.CachedFilteredLocation", b =>
                {
                    b.HasOne("Core.Entities.Shared.Adress", "CachedAdress")
                        .WithMany("CachedFilteredLocations")
                        .HasForeignKey("CachedAdressID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CachedAdress");
                });
            ...
            modelBuilder.Entity("Core.Entities.Shared.Adress", b =>
                {
                    ...
                    b.Navigation("CachedFilteredLocations");
