...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250331093442_refreshToken-table-minor-changes")]
    partial class refreshTokentableminorchanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.AdvertDependent.AdvertExposures", b =>
                {
                    b.Property<int>("AdvertExposuresID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdvertExposuresID"));

                    b.Property<int>("AdvertID")
                        .HasColumnType("int");

                    b.Property<int>("ExposureAmount")
                        .HasColumnType("int");

                    b.Property<DateTime>("ExposureDate")
                        .HasColumnType("datetime2");

                    b.HasKey("AdvertExposuresID");

                    b.HasIndex("AdvertID");

                    b.ToTable("AdvertExposures");
                });
            ...
            modelBuilder.Entity("Core.Entities.UserDependent.RefreshToken", b =>
                {
