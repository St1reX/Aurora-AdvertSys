...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250218152619_entities-spelling-issue-fix")]
    partial class entitiesspellingissuefix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.UserDependent.CachedAddress", b =>
                {
                    b.Property<int>("CachedAddressID")
                        .HasColumnType("int");

                    b.Property<int>("AddressID")
                        .HasColumnType("int");

                    b.HasKey("CachedAddressID");
            ...
            modelBuilder.Entity("Core.Entities.UserDependent.CachedAddress", b =>
                {
                    b.HasOne("Core.Entities.Shared.Address", "Address")
                        .WithMany("CachedAddresses")
                        .HasForeignKey("CachedAddressID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
